...
var grammar = {
    ...
    {"name": "attribute_selector$ebnf$1$subexpression$1", "symbols": ["__", "attr_modifier"], "postprocess": d => d[1]},
    {"name": "attribute_selector$ebnf$1", "symbols": ["attribute_selector$ebnf$1$subexpression$1"], "postprocess": id},
