...
var grammar = {
    ...
    {"name": "wschar", "symbols": [/[ \t\n\v\f]/], "postprocess": id},
    {"name": "selector_list", "symbols": ["_", "complex_selector_list", "_"]},
    ...
    {"name": "complex_selector_list", "symbols": ["complex_selector", "complex_selector_list$ebnf$1"]},
    ...
    {"name": "complex_selector$ebnf$1$subexpression$1$ebnf$1", "symbols": ["combinator"], "postprocess": id},
    {"name": "complex_selector$ebnf$1$subexpression$1$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "complex_selector$ebnf$1$subexpression$1", "symbols": ["complex_selector$ebnf$1$subexpression$1$ebnf$1", "compound_selector"]},
    ...
    {"name": "complex_selector", "symbols": ["compound_selector", "complex_selector$ebnf$1"]},
    ...
    {"name": "relative_selector", "symbols": ["relative_selector$ebnf$1", "complex_selector"]},
    {"name": "compound_selector$ebnf$1", "symbols": []},
    {"name": "compound_selector$ebnf$1", "symbols": ["compound_selector$ebnf$1", "subclass_selector"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "compound_selector$ebnf$2", "symbols": []},
    {"name": "compound_selector$ebnf$2$subexpression$1$ebnf$1", "symbols": []},
    {"name": "compound_selector$ebnf$2$subexpression$1$ebnf$1", "symbols": ["compound_selector$ebnf$2$subexpression$1$ebnf$1", "pseudo_class_selector"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "compound_selector$ebnf$2$subexpression$1", "symbols": ["pseudo_element_selector", "compound_selector$ebnf$2$subexpression$1$ebnf$1"]},
    {"name": "compound_selector$ebnf$2", "symbols": ["compound_selector$ebnf$2", "compound_selector$ebnf$2$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "compound_selector", "symbols": ["type_selector", "compound_selector$ebnf$1", "compound_selector$ebnf$2"]},
    {"name": "compound_selector$ebnf$3", "symbols": ["subclass_selector"]},
    {"name": "compound_selector$ebnf$3", "symbols": ["compound_selector$ebnf$3", "subclass_selector"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "compound_selector$ebnf$4", "symbols": []},
    {"name": "compound_selector$ebnf$4$subexpression$1$ebnf$1", "symbols": []},
    {"name": "compound_selector$ebnf$4$subexpression$1$ebnf$1", "symbols": ["compound_selector$ebnf$4$subexpression$1$ebnf$1", "pseudo_class_selector"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "compound_selector$ebnf$4$subexpression$1", "symbols": ["pseudo_element_selector", "compound_selector$ebnf$4$subexpression$1$ebnf$1"]},
    {"name": "compound_selector$ebnf$4", "symbols": ["compound_selector$ebnf$4", "compound_selector$ebnf$4$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "compound_selector", "symbols": ["compound_selector$ebnf$3", "compound_selector$ebnf$4"]},
    {"name": "compound_selector$ebnf$5$subexpression$1$ebnf$1", "symbols": []},
    {"name": "compound_selector$ebnf$5$subexpression$1$ebnf$1", "symbols": ["compound_selector$ebnf$5$subexpression$1$ebnf$1", "pseudo_class_selector"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "compound_selector$ebnf$5$subexpression$1", "symbols": ["pseudo_element_selector", "compound_selector$ebnf$5$subexpression$1$ebnf$1"]},
    {"name": "compound_selector$ebnf$5", "symbols": ["compound_selector$ebnf$5$subexpression$1"]},
    {"name": "compound_selector$ebnf$5$subexpression$2$ebnf$1", "symbols": []},
    {"name": "compound_selector$ebnf$5$subexpression$2$ebnf$1", "symbols": ["compound_selector$ebnf$5$subexpression$2$ebnf$1", "pseudo_class_selector"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "compound_selector$ebnf$5$subexpression$2", "symbols": ["pseudo_element_selector", "compound_selector$ebnf$5$subexpression$2$ebnf$1"]},
    {"name": "compound_selector$ebnf$5", "symbols": ["compound_selector$ebnf$5", "compound_selector$ebnf$5$subexpression$2"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "compound_selector", "symbols": ["compound_selector$ebnf$5"]},
    {"name": "simple_selector", "symbols": ["type_selector"]},
    {"name": "simple_selector", "symbols": ["subclass_selector"]},
    ...
    {"name": "type_selector", "symbols": ["wq_name"]},
    ...
    {"name": "type_selector", "symbols": ["type_selector$ebnf$1", {"literal":"*"}]},
    ...
    {"name": "ns_prefix", "symbols": ["ns_prefix$ebnf$1", {"literal":"|"}]},
    {"name": "wq_name$ebnf$1", "symbols": ["ns_prefix"], "postprocess": id},
    {"name": "wq_name$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "wq_name", "symbols": ["wq_name$ebnf$1", "ident_token"]},
    {"name": "subclass_selector", "symbols": ["id_selector"]},
    {"name": "subclass_selector", "symbols": ["class_selector"]},
    {"name": "subclass_selector", "symbols": ["attribute_selector"]},
    {"name": "subclass_selector", "symbols": ["pseudo_class_selector"]},
    {"name": "id_selector", "symbols": ["hash_token"]},
    {"name": "class_selector", "symbols": [{"literal":"."}, "ident_token"]},
    {"name": "attribute_selector", "symbols": [{"literal":"["}, "wq_name", {"literal":"]"}]},
    ...
    {"name": "attribute_selector", "symbols": [{"literal":"["}, "wq_name", "attr_matcher", "string_or_ident", "attribute_selector$ebnf$1", {"literal":"]"}]},
    ...
    {"name": "attr_matcher", "symbols": ["attr_matcher$ebnf$1", {"literal":"="}]},
    {"name": "attr_modifier", "symbols": [{"literal":"i"}]},
    {"name": "attr_modifier", "symbols": [{"literal":"s"}]},
    {"name": "string_or_ident", "symbols": ["string_token"]},
    {"name": "string_or_ident", "symbols": ["ident_token"]},
    {"name": "pseudo_class_selector", "symbols": [{"literal":":"}, "ident_token"]},
    ...
    {"name": "pseudo_class_selector", "symbols": [{"literal":":"}, "function_token", "pseudo_class_selector$ebnf$1", {"literal":")"}]},
    {"name": "pseudo_element_selector", "symbols": [{"literal":":"}, "pseudo_class_selector"]},
    {"name": "function_token", "symbols": ["ident_token", {"literal":"("}]},
    ...
    {"name": "string_token", "symbols": [{"literal":"\""}, "string_token$ebnf$1", {"literal":"\""}]},
    ...
    {"name": "string_token", "symbols": [{"literal":"'"}, "string_token$ebnf$2", {"literal":"'"}]},
    ...
    {"name": "ident_token$subexpression$1", "symbols": ["ident_token$subexpression$1$ebnf$1", "char"]},
    ...
    {"name": "ident_token", "symbols": ["ident_token$subexpression$1", "ident_token$ebnf$1"]},
    ...
    {"name": "hash_token", "symbols": [{"literal":"#"}, "hash_token$ebnf$1"]},
    {"name": "char$subexpression$1", "symbols": [/[a-zA-Z0-9_-]/]},
    {"name": "char$subexpression$1", "symbols": [/[^\x00-\x7F]/]},
    {"name": "char", "symbols": ["char$subexpression$1"]},
    {"name": "char", "symbols": ["escape"]},
    ...
    {"name": "escape", "symbols": [{"literal":"\\"}, "hex_digit", "escape$ebnf$1", "escape$ebnf$2", "escape$ebnf$3", "escape$ebnf$4", "escape$ebnf$5", "_"]},
    {"name": "hex_digit", "symbols": [/[0-9a-fA-F]/]},
